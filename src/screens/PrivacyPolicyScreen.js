...
import { privacyPolicyTexts as t } from '../constants/policyTexts';
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <Text style={styles.bulletPoint}>{t.section2Bullet3[language]}</Text>
        <Text style={styles.bulletPoint}>{t.section2Bullet4[language]}</Text>
        <Text style={styles.text}>{t.section2Important[language]}</Text>
        ...
        <Text style={styles.text}>{t.section4Important[language]}</Text>

        <Text style={styles.sectionTitle}>{t.section5Title[language]}</Text>
        <Text style={styles.text}>{t.section5Text[language]}</Text>

        <Text style={styles.sectionTitle}>{t.section6Title[language]}</Text>
        <Text style={styles.text}>{t.section6Text[language]}</Text>
        <Text style={styles.bulletPoint}>{t.section6Bullet1[language]}</Text>
        <Text style={styles.bulletPoint}>{t.section6Bullet2[language]}</Text>
        <Text style={styles.bulletPoint}>{t.section6Bullet3[language]}</Text>
        ...
        <Text style={styles.text}>{t.section7Important[language]}</Text>
        ...
        <Text style={styles.bulletPoint}>{t.section10Email[language]}</Text>
